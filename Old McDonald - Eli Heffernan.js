...
const animals = [duck, wolf, cow, pig, cat, sheep, crow, tiger, frog, dog, fox];
/*********************************************/
...
console.log ("and on his farm he had a " + animals[i].animalName);

console.log (eio + "\n");


console.log ("With a " + animals[i].animalSound + " here" );

    console.log ("And a " + animals[i].animalSound + " there" );

    console.log ("Here a " + animals[i].sound + " " + "there a " + animals[i].animalSound);

    console.log ("Everywhere a " + animals[i].animalSound);
